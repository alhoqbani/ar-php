...
class NormaliseTest extends AbstractTestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->normalise = new Arabic('Normalise');
    }

    /** @test */
    public function it_loads_normalise_class()
    {
        $this->assertInstanceOf(Normalise::class, $this->normalise->myObject);
    }
    ...
    /** @test */
    public function it_can_check_if_passed_character_is_alef()
    {
        $this->assertTrue((bool) $this->normalise->isAlef('أ'));
        $this->assertFalse((bool) $this->normalise->isAlef('ج'));
    }

    /** @test */
    public function it_can_check_if_passed_character_is_week()
    {
        $this->assertTrue((bool) $this->normalise->isWeak('و'));
        $this->assertFalse((bool) $this->normalise->isWeak('ج'));
    }

    /** @test */
    public function it_can_check_if_passed_character_is_yeh_like()
    {
        $this->assertTrue((bool) $this->normalise->isYehlike('ي'));
        $this->assertTrue((bool) $this->normalise->isYehlike('ى'));
        $this->assertFalse((bool) $this->normalise->isYehlike('ج'));
    }

    /** @test */
    public function it_can_check_if_passed_character_is_waw_like()
    {
        $this->assertTrue((bool) $this->normalise->isWawlike('و'));
        $this->assertTrue((bool) $this->normalise->isWawlike('ؤ'));
        $this->assertFalse((bool) $this->normalise->isWawlike('ج'));
    }

    /** @test */
    public function it_can_check_if_passed_character_is_teg_like()
    {
        $this->assertTrue((bool) $this->normalise->isTehlike('ت'));
